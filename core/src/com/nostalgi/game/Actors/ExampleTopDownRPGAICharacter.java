 ...
 */
public class ExampleTopDownRPGAICharacter extends BaseCharacter implements ICharacter {
    ...
    public ExampleTopDownRPGAICharacter(IWorld world, ArrayList<BoundingVolume> boundingVolumes) {
        ...
        this.setAIControllerClass(ExampleNPCAIController.class);
        this.shouldBePossessedOnSpawn(true);
        this.shouldSpawnWithAiController(true);
    }
